...
$this->select(	'page_section',
				...
				array('default' => 'Default Section', 'home' => 'Home Section', 'portfolio' => 'Portfolio Section', 'parallax' => 'Parallax Section','parallaxclassic' => 'Classic Parallax Section', 'contact' => 'Contact Section'),
				''
            );
