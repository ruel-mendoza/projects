...
$of_options[] = array( "name" 		=> __("Home Layout Type", THEME_LANGUAGE_DOMAIN),
                    ...
                    "std"       => "Image Pattern",
                    "type" 		=> "select",
                    "options" 	=> array("Image Pattern", "Full Screen Slider", "Full Width Parallax Slider", "Full Screen Image Parallax", "Full Screen Video Background", "Full Screen Moving Background"));
