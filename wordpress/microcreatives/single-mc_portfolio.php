<?php
	if ( have_posts() ) {
        ...
        if( get_post_meta(get_the_ID(), 'mc_portfolio_item_layout', true) == "external" ){
...
<?php
            if( get_post_meta(get_the_ID(), 'mc_portfolio_item_layout', true) == "slider" ){

                get_template_part('sections/portfolio_item_slider');
            }
            else if( get_post_meta(get_the_ID(), 'mc_portfolio_item_layout', true) == "full_screen" ){
